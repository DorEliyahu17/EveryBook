...
namespace EveryBook.Controllers
{
    public class BugsController : Controller
    {
        ...
        {
            var everyBookContext = _context.Bug.Include(b => b.User);
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,UserId")] Bug bug)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Set<User>(), "Id", "Id", bug.UserId);
            return View(bug);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Title,Description,UserId")] Bug bug)
        {
            if (id != bug.Id)
            {
                return NotFound();
