    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DistributionUnit", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DistributionUnit_Location_LocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DistributionUnitId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_DistributionUnit_DistributionUnitId",
                        column: x => x.DistributionUnitId,
                        principalTable: "DistributionUnit",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ExtendUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bug", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Bug_AspNetUsers_ExtendUserId",
                        column: x => x.ExtendUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Order_AspNetUsers_ExtendUserId",
                        column: x => x.ExtendUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_DistributionUnitId",
                table: "AspNetUsers",
                column: "DistributionUnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bug_ExtendUserId",
                table: "Bug",
                column: "ExtendUserId");

            migrationBuilder.CreateIndex(
                name: "IX_DistributionUnit_LocationId",
                table: "DistributionUnit",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_Order_ExtendUserId",
                table: "Order",
                column: "ExtendUserId");
        }
